...
class AnnotationRepo:
    ...
    def update_annotation(self, set_name: str, path: str, new_label: str, new_desc: str):
        ...
        """
        self.cursor.execute(
            "UPDATE annotation SET label=?, desc=? WHERE set_name=? AND path_url=?",
    ...
    def delete_annotation(self, set_name: str, path: str):
        ...
        """
        self.cursor.execute(
            "DELETE FROM annotation WHERE set_name=? AND path_url=?", [set_name, path]
        )
        self.connection.commit()
    ...
    def update_patient(self, patient_id, patient_name: str, new_name: str):
        ...
        """
        self.cursor.execute(
            "UPDATE patient SET name=? WHERE id=? AND name=?", [new_name, patient_id, patient_name]
        )
        self.connection.commit()
